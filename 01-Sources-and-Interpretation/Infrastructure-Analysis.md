...
<!-- Copy paste this file into that web app, the paste the resulting table of contents below this -->
- [Infrastructure Analysis](#infrastructure-analysis)
  - [Core PureScript Projects and Maintainers](#core-purescript-projects-and-maintainers)
    - [PureScript Maintainers](#purescript-maintainers)
    - [PureScript Compiler/Language](#purescript-compilerlanguage)
      - [The `purs docs` Command](#the-purs-docs-command)
      - [How does it work?](#how-does-it-work)
      - [How could improvements here greatly benefit the entire ecosystem?](#how-could-improvements-here-greatly-benefit-the-entire-ecosystem)
    - [Pursuit](#pursuit)
      - [What does PS' main documentation website, Pursuit, currently do well?](#what-does-ps-main-documentation-website-pursuit-currently-do-well)
      - [What does PS' main documentation website, Pursuit, currently not do at all but should do?](#what-does-ps-main-documentation-website-pursuit-currently-not-do-at-all-but-should-do)
        - [Things mentioned in the Pursuit Issue Tracker on GitHub](#things-mentioned-in-the-pursuit-issue-tracker-on-github)
        - [Gains in making search more useful](#gains-in-making-search-more-useful)
        - [Gains in making it easier to understand the ecosystem](#gains-in-making-it-easier-to-understand-the-ecosystem)
        - [Gains that help indicate old libraries](#gains-that-help-indicate-old-libraries)
        - [Gains in code readability](#gains-in-code-readability)
        - [Gains in other aspects](#gains-in-other-aspects)
      - [Things not highlighted in Pursuit Issue Tracker on GitHub](#things-not-highlighted-in-pursuit-issue-tracker-on-github)
    - [Buld Tool Integration with Pursuit](#buld-tool-integration-with-pursuit)
  - [PureScript Website](#purescript-website)
  - [PureScript Documentation](#purescript-documentation)
  - [PureScript Prelude](#purescript-prelude)
  - [Pulp Build Tool](#pulp-build-tool)
  - [psc-package Dependency Manager](#psc-package-dependency-manager)
  - [Package-sets for psc-package](#package-sets-for-psc-package)
  - [Spago build tool/dependency manager](#spago-build-tooldependency-manager)
  - [Pre-existing PureScript Learning Resources](#pre-existing-purescript-learning-resources)
    - [Learning Resources targeting different backgrounds](#learning-resources-targeting-different-backgrounds)
      - [PS' Differences from Haskell](#ps-differences-from-haskell)
      - [PS' Differences from Elm](#ps-differences-from-elm)
  - [Other FP Learning Resources](#other-fp-learning-resources)
    - [What I Wish I knew When Learning Haskell](#what-i-wish-i-knew-when-learning-haskell)
    - [Haskell Programming: From First Principles](#haskell-programming-from-first-principles)
    - [Specific Topics in Haskell](#specific-topics-in-haskell)
...
## Core PureScript Projects and Maintainers

Following is a list of projects which have significant impact on the PureScript language's user experience. Types of projects this includes is documentation and build tools.

### PureScript Maintainers

[PureScript Organization](https://github.com/purescript) Members:
...
[PureScript compiler/language](https://github.com/purescript/purescript) main contributors (by commits):
